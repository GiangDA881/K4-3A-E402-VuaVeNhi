...
## 3. Tổng kết 4 Dòng Quyết Định Sản Phẩm (Bắt buộc theo Rubric R6)
...
2. **Sẽ sửa gì trước demo:**
   ...
   - **Tối ưu Touch Target:** Mở rộng padding các nút bấm card kết quả (`Mở đúng đoạn →`, `Xác nhận nguồn`) đảm bảo bấm nhạy 100% trên mọi kích thước màn hình thuyết trình.
